...
return array(
	...
	'validate' => "
		...
		array('module_name', '1,30', '对应的模块名的值最长不能超过 30 个字符！', 2, 'length', 3),
		array('controller_name', '1,30', '对应的控制器名的值最长不能超过 30 个字符！', 2, 'length', 3),
		array('action_name', '1,30', '对应的方法名的值最长不能超过 30 个字符！', 2, 'length', 3),
